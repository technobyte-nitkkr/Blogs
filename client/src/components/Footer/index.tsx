...
import { faTwitter, faFacebookF, faLinkedinIn, faYoutube, faTwitch, faTiktok, faGithub } from "@fortawesome/free-brands-svg-icons"; // Social media icons

export default function Footer() {
    return (
        <footer className="text-gray-400 py-4 px-8" style={{ backgroundColor: '#161B22' }}>
   <div className="flex justify-between items-center">
                {/* Left Side: Text and Links */}
                <div className="flex space-x-6 text-sm">
                    <span>© 2024 Techspardha, Inc.</span>
                    <a href="/" className="hover:text-white">Terms</a>
                    <a href="/" className="hover:text-white">Privacy (Updated 10/2024)</a>
                ...
                <div className="flex space-x-4">
                    ...
                    <a href="https://twitch.tv" aria-label="Twitch" className="hover:text-white">
