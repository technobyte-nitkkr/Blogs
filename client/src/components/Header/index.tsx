...
import { faMagnifyingGlass, faUserCircle } from "@fortawesome/free-solid-svg-icons"; // Import the user circle icon

export default function Header() {
    return (
        <>
            <header className="p-5 flex flex-row items-center bg-black text-white m-0 w-full h-[72px]">
                <div className="flex items-center mx-5"> {/* Container for logo */}
                <img 
...
>
    Blogs
                ...
                <nav className="flex-grow text-left -ml-20 md:mr-0 lg:mr-80 md-custom:mr-80">
                    <ul className="list-none p-0 m-0 flex justify-center space-x-5 sm:flex hidden"> {/* Navigation list */}
